...
#include <algorithm>
#include <cmath>
#include "ExactHigestFirstMappingOptimization.h"

ExactHigestFirstMappingOptimization::ExactHigestFirstMappingOptimization() : Optimization() {
}

ExactHigestFirstMappingOptimization::ExactHigestFirstMappingOptimization(ExactHigestFirstMappingOptimization& other)  : Optimization(other) {
}

Configuration ExactHigestFirstMappingOptimization::optimize(Configuration config) {
